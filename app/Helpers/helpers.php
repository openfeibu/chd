...
if (!function_exists('handle_array_images')) {
    function handle_array_images($arrays, $image_name='',$host = '')
    {
        foreach ($arrays as $key => $arr) {
            $arrays[$key][$image_name] = handle_image_url($arrays[$key][$image_name], $host);
        }
        return $arrays;
    }
}
